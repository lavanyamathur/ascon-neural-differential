...
def main():
    ...
    check = ModelCheckpoint('saved_model/best4_s=4096_trained.h5', monitor='val_loss', save_best_only=True)
    h = model_s.fit(X, Y, epochs=num_epochs, batch_size=64, shuffle=True,
