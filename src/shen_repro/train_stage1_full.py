...
def main():
    ...
    checkpoint = ModelCheckpoint(
        'ascon_stage1_full_10M_best.keras',
    ...
    model.save('ascon_stage1_full_10M_final.keras')
    print("Final-epoch model saved to ascon_stage1_full_10M_final.keras")
    print("Best-val_accuracy model saved to ascon_stage1_full_10M_best.keras")
